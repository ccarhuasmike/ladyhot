...
namespace ApiAnuncio.Controllers
{
    ...
    public class ApiAnuncioController : ApiController
    {
        ...
        [Route("GetAnucionXId"), HttpPost]
        public ClientResponse GetAnucionXId(int id)
        {
            ClientResponse clientResponse = new ClientResponse();
            try
            {
        ...
        [Route("Segundopaso"), HttpPost]
        public ClientResponse Segundopaso(Tbl_anuncio oregistro)
        {
            ClientResponse clientResponse = new ClientResponse();
            try
            {
        ...
        [Route("Tercerpaso"), HttpPost]
        public ClientResponse Tercerpaso(Tbl_anuncio oregistro)
        {
            ClientResponse clientResponse = new ClientResponse();
            try
            {
        ...
        [Route("Cuartopaso"), HttpPost]
        public ClientResponse Cuartopaso(Tbl_anuncio oregistro)
        {
            ClientResponse clientResponse = new ClientResponse();
            try
            {
                clientResponse = new AnuncioLogic().UpdateCuartopaso(oregistro);
            }
            catch (Exception ex)
            {
                clientResponse = Utilidades.ObtenerMensajeErrorWeb(ex);
        ...
        [Route("AgregarFotos"), HttpPost]
        public ClientResponse AgregarFotos(int id)
        {
            ClientResponse clientResponse;
            try
            {
